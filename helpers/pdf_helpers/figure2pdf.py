...
def save_figure_skychart(
     ...
     with PdfPages(filename) as pdf:
         ...
         tasks = [
             '1. Обозначьте точку зенита символом «$Z$» и стороны света «$N, E, S, W$».',
             '2. Обозначьте точку полюса мира символом «$P$» и проведите небесный меридиан.',
             '3. Проведите небесный экватор и обозначьте точку \n весеннего равноденствия символом «♈»'
             '   \n или точку осеннего равноденствия символом «♎».',
             '4. Звездное время: ' + '_' * 20,
             '5. Учитывая, что скайчарт приведен в стереографической проекции,\n определите широту\n'
             '   места наблюдения: ' + '_' * 20,
             '6. Проведите контуры всех созвездий \n и напишите сокращения их названий по Байеру.',
         ]
