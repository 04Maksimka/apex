...
def render_and_save(cfg: StereoProjConfig, filename: str, random_angle: float, sample_dir: Path, teacher: bool = False):
    """ Render helper. """
...
def generate_stereo_samples(
    ...
    :param time_interval: the time interval from which a random time will be taken to generate the map
